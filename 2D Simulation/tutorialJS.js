...
function initInstructions() {
    ...
    introductions1.push("Sorting:<br>&emsp;Your task is to sort the blocks in a particular way.<br>User1 Instructions:<br>&emsp; The title on this page tells you how to sort the blocks. You partner knows it is a sorting task but doesn’t know how to sort the blocks. Instruct your partner to complete the task, by speaking into your device’s microphone, or by typing in the text box. You can only speak/type after pressing the start button. Your partner will be able to hear what you say and see what you type. You can also use gestures to point to the intended card/position to communicate effectively. You can use these gestures while speaking or at any time while playing the game.<br>&emsp;The partner will assist you in the sorting task according to your instructions but only you can speak to him, and gesture. The partner can’t speak back, or gesture. For this game, you can’t flip or move blocks. Only your partner can do that. Both of you will be able to see anything either of you do on the table.");
    introductions2.push("Sorting:<br>&emsp;Your task is to sort the blocks in a particular way.<br>User2 Instructions:<br>&emsp;Your partner will give you instructions to complete the task. Your partner might also point while speaking or at any time while playing the game so you must pay attention to them and try to cooperate. You can flip and move blocks but your partner can’t. You have to follow your partner’s instructions and try to assist your partner in the best possible way. Both of you will will be able to see anything either of you do on the table.<br>");
    introductions1.push("Matching:<br>Your task is to match the blocks in a particular way. The user who can give instructions is user1 and the one who can’t is user2. Once the game starts, user1 will flip two blocks. If the blocks match, user2 should drag both the blocks to the left. If they don’t, user2 will drag both the blocks to the right. Your goal is to flip all the blocks. If one block is left at the end, user2 will drag it to the left and click the end button.<br>User1 Instructions:<br>&emsp;Based on the matching criteria specified at the top of the screen, you will instruct your partner in order to get help finishing the task, by speaking into your device’s microphone, or by typing in the text box. Your partnre knows you are playing a matching game but doesn’t know anything about the matching criteria. You can only speak/type after pressing the start button. Your partner will be able to hear what you say and see what you type. You can also use gestures to point to the intended card/position to communicate effectively. You can use these gestures while speaking or at any time while playing the game.<br>&emsp;Your partner will be able to hear what you say and see what you type but they will not be able to talk or type to you. Both of you will see the outcomes of any changes either of you make to the table.<br>");
    introductions2.push("Matching:<br>our task is to match the blocks in a particular way. The user who can give instructions is user1 and the one who can’t is user2. Once the game starts, user1 will flip two blocks. If the blocks match, user2 should drag both the blocks to the left. If they don’t, user2 will drag both the blocks to the right. Your goal is to flip all the blocks. If one block is left at the end, user2 will drag it to the left and click the end button.<br>User2 Instructions:<br>&emsp;Your partner will give you instructions to complete the task. Your partner might also use gestures while speaking or at any time while playing the game so you must pay attention to them, try to understand what those gestures mean and do work accordingly. You have to follow his instructions and try to assist him in the best possible way. Both of you will see the outcomes of any changes either of you make to the table.<br>");
